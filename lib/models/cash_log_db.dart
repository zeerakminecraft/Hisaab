...
class CashLogDatabase {
  ...
  Future<CashLog> create(CashLog cashLog) async {
    ...
    final columns =
        '${CashLogDBFields.cashIn}, ${CashLogDBFields.cashOut}, ${CashLogDBFields.description}, ${CashLogDBFields.time}';
    final values =
        '${json[CashLogDBFields.cashIn]},${json[CashLogDBFields.cashOut]}, ${json[CashLogDBFields.description]}, ${json[CashLogDBFields.time]}}';
